...
I build software through AI-native, agent-directed development: defining the
product, setting constraints, directing implementation and testing the result.
My work spans agent tooling, React/TypeScript applications and WordPress/PHP/Elementor.
...
Each repository describes its architecture, verification and current boundaries.
The projects above are independent work. AI coding agents produce much of the
implementation under my direction; I own the product intent, constraints,
architectural decisions, iteration and acceptance of the resulting software.

## Em português

Construo aplicações e ferramentas dirigindo agentes de desenvolvimento, com foco
em requisitos, decisões de arquitetura, implementação e validação. Os projetos
reúnem interfaces React/TypeScript, sistemas para agentes e integrações WordPress/Elementor.
